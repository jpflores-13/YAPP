...
##make pdf
pdf(file = "plots/lostLoops_isDroso_rect.pdf",
    width = 7,
    height = 8)
...
for(i in 1:nrow(loopRegions_lost)){
  ...
  p <- pgParams(assembly = "hg19",
                resolution = 5e3,
                chrom = loopRegions_lost$seqnames[5],
                chromstart = loopRegions_lost$start[5],
                chromend = loopRegions_lost$end[5],
                zrange = c(0,100),
                norm = "KR",
                x = 0.25,
                width = 5,
  ...
  annoPixels(plot = middle,
             data = c("data/hic/noDroso/cont/loops/5kbLoops.txt"),
             type = "box",
             shift = 1)
  
  annoPixels(plot = middle,
             data = "data/hic/isDroso/cont/loops/5kbLoops.txt",
             type = "triangle",
             shift = 1)
  ...
  annoPixels(plot = bottom,
             data = "data/hic/noDroso/sorb/loops/5kbLoops.txt",
             type = "box",
             shift = 1)
  
  annoPixels(plot = bottom,
             data = "data/hic/isDroso/sorb/loops/5kbLoops.txt",
             type = "triangle",
             shift = 1)
  ...
  plotText(label = "`-isDroso = FALSE` = box",
           y = 3.5,
           x = 6,
           just = c("center", "center"),
           col = "red")
  
  plotText(label = "`-isDroso = TRUE` = triangle",
           y = 4,
           x = 6,
           just = c("center", "center"))
