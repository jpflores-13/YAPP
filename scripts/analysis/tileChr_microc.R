...
# Set-up params -----------------------------------------------------------
pdf(file = "plots/YAPP_microc_SCALE_tile_chr1.pdf",
    width = 6,
    height = 7.5)
...
for (i in seq_along(tile)){
  ...
  omega <- plotHicRectangle(data = "data/raw/microc/hg38_220801/220717_dietJuicerMerge_omega/YAPP_HEK_inter_30.hic",
                            params = p,
                            y = 0.5) |> 
  ...
  cont <- plotHicRectangle(data = "data/raw/microc/hg38_220801/220717_dietJuicerMerge_condition/cont/YAPP_HEK_cont_inter_30.hic",
                           params = p,
                           y = 2.5) |> 
    annoHeatmapLegend(orientation = "v",
                      fontsize = 8,
  ...
  sorb <- plotHicRectangle(data = "data/raw/microc/hg38_220801/220717_dietJuicerMerge_condition/sorb/YAPP_HEK_sorb_inter_30.hic",
                           params = p,
                           y = 4.5) |> 
    annoHeatmapLegend(orientation = "v",
                      fontsize = 8,
