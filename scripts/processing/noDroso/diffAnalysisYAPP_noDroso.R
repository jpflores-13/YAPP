...
# Load Data--------------
load("data/processed/hic/noDroso/loopCounts.rda")
...
summary(res)
pdf(file = "plots/YAPP_diffLoops_sorb_MA_noDroso_betaPriorT.pdf")
...
save(diff_loopCounts, file = "data/processed/hic/noDroso/diff_loopCounts.rda")
